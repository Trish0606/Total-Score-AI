...
with st.sidebar:
    ...
    # Configuration updated for WNBA (40 mins) vs NBA (48 mins)
    params = {"nba": {"pace": 2.15, "baseline": 220.5, "mins": 48.0}, 
              "wnba": {"pace": 1.95, "baseline": 165.5, "mins": 40.0}}[league]
...
def render_live_terminal():
    ...
    if not active_games:
        st.info("No active games right now. Awaiting tip-off.")
        return
    ...
    for game in active_games:
        ...
        c1.metric("1H Total", f"{game.get('1h_score', 0)} pts")
        c2.metric("Total Score", game.get('total', 0), delta="Current Game")
        ...
        # Table omitted for brevity, add back as needed
with tab1:
